  ...
  return (
    <>
      ...
      >
        ...
        {/* User Card */}
        {user && (
          <div className="mx-3 mt-3 mb-2 rounded-lg bg-white/5 border border-sidebar-border p-3">
            <div className="flex items-center gap-3">
              <div className={cn('h-8 w-8 rounded-full flex items-center justify-center text-xs font-bold text-white bg-gradient-to-br', gradient)}>
                {initials}
              </div>
              <div className="flex-1 min-w-0">
                ...
                <span className="inline-block text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-gold-500/20 text-gold-400 border border-gold-500/30 mt-0.5">
                  {user.role}
                </span>
              </div>
            </div>
